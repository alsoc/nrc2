...
void write_ui64vector (uint64  *v,long nl,long nh, char *format, char *filename);
...
void write_f32vector_T  (float32 *v,long nl,long nh, char *format, char *filename);
void write_f64vector_T  (float64 *v,long nl,long nh, char *format, char *filename);
