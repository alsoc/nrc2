...
void display_ui16vector_circular (uint16   *v,long nl,long nh, long c0, long c1, const char *format, const char *name);
...
void display_ui16vector_circular_number(uint16  *v,long nl,long nh, long c0, long c1, const char *format, const char *name);
void display_f32vector_circular_number (float32 *v,long nl,long nh, long c0, long c1, const char *format, const char *name);
void display_f64vector_circular_number (float64 *v,long nl,long nh, long c0, long c1, const char *format, const char *name);
