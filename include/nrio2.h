...
void display_i32matrix_number (sint32 **m,long nrl,long nrh,long ncl, long nch, char *format, char *name);
...
void write_si16matrix_T (sint16  **m,long nrl,long nrh,long ncl, long nch, char *format, char *filename);
void write_ui16matrix_T (uint16  **m,long nrl,long nrh,long ncl, long nch, char *format, char *filename);
...
void write_rgbx8matrix_number(rgbx8   **m,long nrl,long nrh,long ncl, long nch, char *format, char *filename);
...
void fread_si16matrix (char *filename, sint16   **m,long nrl,long nrh,long ncl, long nch);
void fread_ui16matrix (char *filename, uint16   **m,long nrl,long nrh,long ncl, long nch);
